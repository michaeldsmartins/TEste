                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="itemsTable">
                                ...
                                <tbody>
                                    <tr class="item-row">
                                        <td>
                                            <select name="items[0][product_id]" class="form-select product-select select2" required data-placeholder="Selecione um produto...">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="total_display" class="form-control fw-bold border-0 bg-transparent" readonly value="R$ 0,00">
                        ...
                        <div class="row align-items-center mb-3">
                            ...
                            <div class="col-md-3">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="number" id="num_installments" class="form-control" value="1" min="1" max="12">
                                </div>
                            </div>
                            <div class="col-md-3">
...
<script>
    $(document).ready(function() {
        ...
        function calculateTotal() {
            ...
            // Auto-gerar parcela única se não houver parcelas geradas
            if ($('#installmentsContainer').children().length === 0) {
                generateInstallments(total, 1);
            }
        }
        ...
        $('#generateInstallments').click(function() {
            ...
            if (total > 0 && num > 0) {
                ...
                alert('Selecione produtos antes de gerar parcelas.');
            }
        });
